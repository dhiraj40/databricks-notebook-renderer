...
const makeConfig = (argv, { entry, out, target, library = 'commonjs' }) => {
    const isModuleLibrary = library === 'module';
    ...
    return {
        ...
        output: {
            ...
            ...(isModuleLibrary ? { chunkFormat: 'module' } : {}),
        },
        externals: {
...
module.exports = (env, argv) => [
    ...
    makeConfig(argv, { entry: './src/extension/extension.web.ts', out: './out/extension/extension.web.js', target: 'webworker' }),
];
